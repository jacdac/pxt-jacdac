...
/* harmony import */ var _styles_useThemeProps__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(89130);
...
// EXTERNAL MODULE: ./src/components/hooks/useMediaQueries.tsx + 1 modules
var useMediaQueries = __webpack_require__(77367);
...
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(29602);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
...
const privateKeys = (/* unused pure expression or super */ null && (['set', 'get', 'setSize', 'setFrameloop', 'setDpr', 'events', 'invalidate', 'advance', 'size', 'viewport']));
...
const CanvasImpl = /*#__PURE__*/react.forwardRef(function Canvas({
  ...
  react.useMemo(() => extend(three_module), []);
...
const Box = shapes_create('box');
const Circle = shapes_create('circle');
const Cone = shapes_create('cone');
const Cylinder = shapes_create('cylinder');
const Sphere = shapes_create('sphere');
const Plane = shapes_create('plane');
const Tube = shapes_create('tube');
const Torus = shapes_create('torus');
const TorusKnot = shapes_create('torusKnot');
const Tetrahedron = shapes_create('tetrahedron');
const Ring = shapes_create('ring');
const Polyhedron = shapes_create('polyhedron');
const Icosahedron = shapes_create('icosahedron');
const Octahedron = shapes_create('octahedron');
const Dodecahedron = shapes_create('dodecahedron');
const Extrude = shapes_create('extrude');
const Lathe = shapes_create('lathe');
const Capsule = shapes_create('capsule');
...
useFrame((state,delta)=>{var{current:mesh}=meshRef;if(!mesh)return;var rot=rotator===null||rotator===void 0?void 0:rotator(delta,mesh.rotation);if(rot){var{x,y,z}=rot;mesh.rotation.x=x;mesh.rotation.y=y;mesh.rotation.z=z;}var pos=positioner===null||positioner===void 0?void 0:positioner(delta,mesh.position);if(pos){var{x:_x,y:_y,z:_z}=pos;mesh.position.x=_x;mesh.position.y=_y;mesh.position.z=_z;}});return/*#__PURE__*/react.createElement("mesh",{ref:meshRef,receiveShadow:true,castShadow:true},/*#__PURE__*/react.createElement("boxGeometry",null),/*#__PURE__*/react.createElement("meshStandardMaterial",{color:color}));}function CanvasWidget(props){var others=Object.assign({},props);// probably a bot or old browser
if(typeof ResizeObserver==="undefined")return null;return/*#__PURE__*/react.createElement(Canvas,{camera:{position:[-1,0.5,2],fov:50}},/*#__PURE__*/react.createElement("hemisphereLight",{intensity:0.35}),/*#__PURE__*/react.createElement("spotLight",{position:[10,10,10],angle:0.3,penumbra:1,intensity:2,castShadow:true}),/*#__PURE__*/react.createElement(Plane,{receiveShadow:true,castShadow:true,args:[5,5],position:[0,-1,0],rotation:[-Math.PI/2,0,0]}),/*#__PURE__*/react.createElement(Cube,others),/*#__PURE__*/react.createElement(OrbitControls_OrbitControls,null));}
...
//# sourceMappingURL=c8f7fe3b0e41be846d5687592cf2018ff6e22687-3bc0c9f07dcbef618d21.js.map