...
/* harmony import */ var _styles_styled__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29602);
/* harmony import */ var _styles_useThemeProps__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(89130);
...
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(29602);
...
/* harmony export */ });
/* unused harmony exports DEFAULT_OPTIONS, shapeToEC30 */
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "ck": function() { return /* binding */ rawUrl; },
  "B5": function() { return /* binding */ useLatestFirmwareRelease; },
  "Ux": function() { return /* binding */ useRepository; }
});

// UNUSED EXPORTS: GITHUB_API_KEY, fetchFirmwareReleaseBinary, fetchLatestFirmwareRelease, fetchText, parseRepoUrl, useFetchJSON, useLatestFirmwareReleases, useLatestRelease, useLatestReleaseAsset

;// CONCATENATED MODULE: ./jacdac-ts/src/jdom/semver.ts
...
var components_useFetch = __webpack_require__(34284);
...
/* harmony import */ var _hooks_useMediaQueries__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(77367);
/* harmony import */ var _hooks_useSnackbar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(37862);
...
/* harmony export */ });
/* harmony import */ var _github__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47249);
...
// EXTERNAL MODULE: ./jacdac-ts/src/jdom/catalog.ts + 1 modules
var catalog = __webpack_require__(5018);
;// CONCATENATED MODULE: ./src/components/specification/DeviceSpecificationCard.tsx
// tslint:disable-next-line: match-default-export-name no-submodule-imports
function DeviceSpecificationCard(props){var{specification,size,onClick,hideChips,hideServices}=props;var{id,name,version,company,services,hardwareDesign,firmwareSource,storeLink,makeCodeRepo,tags}=specification;var imageUrl=(0,useDeviceImage/* default */.Z)(specification,size);var names=[(tags===null||tags===void 0?void 0:tags.indexOf("kit"))>-1?"kit":undefined,(tags===null||tags===void 0?void 0:tags.indexOf("hub"))>-1?"hub":undefined,(tags===null||tags===void 0?void 0:tags.indexOf("adapter"))>-1?"adapter":undefined].concat((0,toConsumableArray/* default */.Z)((0,utils/* uniqueMap */.EM)(services||[],srv=>srv+"",srv=>srv).map(sc=>{var _serviceSpecification;return (0,jdspec/* humanify */.lW)((_serviceSpecification=(0,spec/* serviceSpecificationFromClassIdentifier */.d5)(sc))===null||_serviceSpecification===void 0?void 0:_serviceSpecification.shortName.toLowerCase());}))).filter(s=>!!s).join(", ");var to=onClick?undefined:"/devices/"+(0,catalog/* identifierToUrlPath */.uM)(id);return/*#__PURE__*/react.createElement(Card/* default */.Z,{raised:true},/*#__PURE__*/react.createElement(gatsby_theme_material_ui/* CardActionArea */.MU,{to:to,onClick:onClick},/*#__PURE__*/react.createElement("img",{src:imageUrl,style:{aspectRatio:"4 / 3",width:"100%"},alt:"photograph of "+specification.name,loading:"lazy"}),/*#__PURE__*/react.createElement(CardContent/* default */.Z,null,/*#__PURE__*/react.createElement(Typography/* default */.Z,{variant:"subtitle2",color:"text.secondary"},company),/*#__PURE__*/react.createElement(Typography/* default */.Z,{gutterBottom:true,variant:"subtitle1",component:"div"},name,version&&/*#__PURE__*/react.createElement(Typography/* default */.Z,{sx:{ml:1},variant:"caption",component:"span"},"v",version)),!hideServices&&names&&/*#__PURE__*/react.createElement(Typography/* default */.Z,{component:"div",variant:"subtitle2"},names),!hideChips&&/*#__PURE__*/react.createElement(ChipList/* default */.Z,null,!storeLink&&/*#__PURE__*/react.createElement(Chip/* default */.Z,{size:"small",label:"prototype"}),!!(makeCodeRepo!==null&&makeCodeRepo!==void 0&&makeCodeRepo.length)&&/*#__PURE__*/react.createElement(Chip/* default */.Z,{size:"small",label:"MakeCode",title:"MakeCode extension available."}),firmwareSource&&/*#__PURE__*/react.createElement(Chip/* default */.Z,{size:"small",label:"firmware code",title:"Firmware source is avaiable."}),hardwareDesign&&/*#__PURE__*/react.createElement(Chip/* default */.Z,{size:"small",label:"hardware design",title:"Hardware design files available."})))));}
// EXTERNAL MODULE: ./src/components/enclosure/ec30.ts
var enclosure_ec30 = __webpack_require__(99458);
...
c=-((0,enclosure_ec30/* isEC30 */.gs)(a.shape)?1:0)+((0,enclosure_ec30/* isEC30 */.gs)(b.shape)?1:0);if(c)return c;// with connectors first
...
/* harmony export */ });
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29602);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
...
/* harmony import */ var _hooks_useMediaQueries__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(77367);
...
//# sourceMappingURL=commons-deabc97439e17d88cf65.js.map